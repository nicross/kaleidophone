engine.utility.octree = {}

engine.utility.octree.create = function (...args) {
  return Object.create(this.prototype).construct(...args)
}

engine.utility.octree.from = function (items = [], options = {}) {
...
engine.utility.octree.prototype = {
  clear: function () {
    this.items.length = 0
    this.nodes.length = 0
    return this
  ...
  split: function () {
    ...
    this.nodes[0] = engine.utility.octree.create({
      depth,
      height,
    ...
    this.nodes[1] = engine.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[2] = engine.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[3] = engine.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[4] = engine.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[5] = engine.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[6] = engine.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
    ...
    this.nodes[7] = engine.utility.octree.create({
      depth,
      height,
      maxItems: this.maxItems,
      width,
