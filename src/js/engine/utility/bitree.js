...
engine.utility.bitree.from = function (items = [], options = {}) {
...
engine.utility.bitree.prototype = {
  clear: function () {
    this.items.length = 0
    this.nodes.length = 0
    return this
  ...
  intersects: function (value, width) {
    return engine.utility.between(this.value, value, value + width)
      || engine.utility.between(value, this.value, this.value + this.width)
  },
