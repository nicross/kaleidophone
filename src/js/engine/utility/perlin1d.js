...
engine.utility.perlin1d = {}

engine.utility.perlin1d.create = function (...args) {
  return Object.create(this.prototype).construct(...args)
}

engine.utility.perlin1d.prototype = {
  ...
  generateGradient: function (x) {
    const srand = engine.utility.srand('perlin', this.seed, x)
  ...
  value: function (x) {
    ...
    return engine.utility.lerp(v0, v1, dx)
  },
}
