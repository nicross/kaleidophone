...
engine.utility.perlin2d = {}

engine.utility.perlin2d.create = function (...args) {
...
engine.utility.perlin2d.prototype = {
  ...
  generateGradient: function (x, y) {
    const srand = engine.utility.srand('perlin', this.seed, x, y)
  ...
  value: function (x, y) {
    ...
    return engine.utility.scale(value, -Math.sqrt(2/4), Math.sqrt(2/4), 0, 1)
  },
}
